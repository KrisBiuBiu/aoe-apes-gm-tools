...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{F704D79A-555A-0B19-1EEA-402BE00C816A}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\node_mmdb.node">
      ...
      <Command>call mkdir &quot;..\lib&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)node_mmdb.node&quot; &quot;..\lib\node_mmdb.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/node_mmdb.node to ./lib\node_mmdb.node</Message>
      <Outputs>..\lib\node_mmdb.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="node_mmdb.vcxproj">
      <Project>{31005C34-A45D-7D44-F476-C6F295A4EB60}</Project>
